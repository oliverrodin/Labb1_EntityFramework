...
Detta är den första labben i kursen Webbapplikationer C# ASP.NET MVC. Denna labb innefattar EntityFramework. Jag har skapat en console-app där anställda kan gå in och skapa ledighetsansökan som sedan sparas i databas med hjälp av EF.
